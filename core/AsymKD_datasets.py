...
class TartanAir(StereoDataset): #../../data
    def __init__(self, seg_any_predictor:SamPredictor, aug_params=None, root='../../data', keywords=[]):
...
class MegaDepth(StereoDataset):
    def __init__(self, seg_any_predictor:SamPredictor, aug_params=None, root='../../data/MegaDepth'):
...
class HRWSI(StereoDataset):
    def __init__(self, seg_any_predictor:SamPredictor, aug_params=None, root='../../data/HRWSI'):
...
class BlendedMVS(StereoDataset):
    def __init__(self, seg_any_predictor:SamPredictor, aug_params=None, root='../../data/BlendedMVS'):
...
def fetch_dataloader(args, seg_any_predictor:SamPredictor, rank, world_size):
    ...
    train_loader = data.DataLoader(train_dataset, batch_size=args.batch_size, drop_last=True, collate_fn=collate_fn, sampler = sampler)
